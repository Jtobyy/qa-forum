...
const Index = ({ httpCode = '', title = '', errMsg = '', showErrorCode = true }) => {
  ...
  return (
    <div className="d-flex flex-column flex-shrink-1 flex-grow-1 justify-content-center align-items-center">
      ...
      {showErrorCode && <h4 className="text-center">{t('http_error', { code: httpCode })}</h4>}
      {title && <h4 className="text-center">{title}</h4>}
      <div className="text-center mb-3 fs-5">{errMsg || t(`desc_${httpCode}`)}</div>
